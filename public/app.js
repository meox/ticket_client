...
var App = function () {
  ...
  _createClass(App, null, [{
    ...
    value: function init() {
      console.log("Hello");
      var socket = new _phoenix.Socket("ws://127.0.0.1:4000/socket", {
        logger: function logger(kind, msg, data) {
          if (kind !== "receive") console.log(kind + ": " + msg, data);
        }
      });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.mychannel = _app2.default.init();
});
});
